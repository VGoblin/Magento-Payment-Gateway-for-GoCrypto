...
namespace GoCryptoPay\GoCryptoPay\Model\Traits;

/**
 * Trait for defining common variables and methods for all Payment Solutions
 * Trait OnlinePaymentMethod
 * @package GoCryptoPay\GoCryptoPay\Model\Traits
 */
trait OnlinePaymentMethod
{
    /**
     * @var \GoCryptoPay\GoCryptoPay\Model\Config
     */
    protected $_configHelper;
    /**
     * @var \GoCryptoPay\GoCryptoPay\Helper\Data
     */
