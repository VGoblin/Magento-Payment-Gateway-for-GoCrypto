...
namespace GoCryptoPay\GoCryptoPay\Helper;

/**
 * Helper Class for all Payment Methods
 *
 * Class Data
 * @package GoCryptoPay\GoCryptoPay\Helper
 */
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    const CODE = 'GoCryptoPay_GoCryptoPay';
     ...
     * @param \GoCryptoPay\GoCryptoPay\Model\ConfigFactory $configFactory,
    ...
    public function __construct(
        ...
        \GoCryptoPay\GoCryptoPay\Model\ConfigFactory $configFactory,
     ...
     * @param  \Magento\Framework\ObjectManagerInterface $objectManager
     * @return \GoCryptoPay\GoCryptoPay\Helper\Data
     */
     ...
     * @return \GoCryptoPay\GoCryptoPay\Model\ConfigFactory
     */
     ...
     * @return \GoCryptoPay\GoCryptoPay\Model\Config
     */
